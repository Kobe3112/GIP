...
def teken_schema(solution):
    ...
    temperaturen = {
        ...
        (26.6, 3.4, "red"): str(solution["T WARMTEWISSELAAR OUT"]) + "°C",
        (26.6, 2.6, "blue"): str(solution["T WARMTEWISSELAAR IN"]) + "°C",
        # WP1
        (23.65, 3.9, "red"): str(solution["T WP1 IN"]) + "°C",
        (22.4, 3.9, "blue"): str(solution["T WP1 OUT"]) + "°C",
        # WP2
        (20.3, 2.1, "red"): str(solution["T WP2 IN"]) + "°C",
        ...
        (18.4, 5.6, "blue"): str(solution["T WP5 OUT"]) + "°C",
        # WP6
    ...
    if WP7_8_9_checkbox:
        temperaturen.update({
        # WP7
        (14, 3.7, "red"): str(solution["T WP7 IN"]) + "°C",
        (14, 4.3, "blue"): str(solution["T WP7 OUT"]) + "°C",
        # WP8
        (16, 3.7, "red"): str(solution["T WP8 IN"]) + "°C",
        (16, 4.3, "blue"): str(solution["T WP8 OUT"]) + "°C",
        # WP9
        (15.65, 2.6, "red"): str(solution["T WP9 IN"]) + "°C",
        (14.4, 2.6, "blue"): str(solution["T WP9 OUT"]) + "°C",
        })
    drempel = 10
